...
export default function DesiderataScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.bg, paddingBottom: insets.bottom }]}>
      <SheetHeader title="Desiderata" subtitle="Richieste personali del personale" onClose={() => router.back()} />
...
const styles = StyleSheet.create({
  ...
  subLabel: { fontSize: 11.5, fontWeight: '600', marginBottom: 5 },
  ...
  prioTag: { fontSize: 11.5, fontWeight: '700', marginTop: 3 },
