...
export default function MatriciScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.bg }]}>
      <SheetHeader title="Matrice utilizzata" subtitle="Catalogo matrici contrattuali e personalizzate" />
        ...
        <Card>
          ...
          <View style={styles.palette}>
            ...
            <Pressable onPress={() => setSeq((p) => p.slice(0, -1))} style={[styles.pBtn, { backgroundColor: colors.card2, borderColor: colors.separator }]}>
              <Ionicons name="backspace-outline" size={18} color={colors.text2} />
            </Pressable>
          </View>
